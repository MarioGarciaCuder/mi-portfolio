...
(function($) {
	...
	var projectCatalog = {
		...
		horarios: {
			...
			summary: 'Aplicación web para la generación automática y optimizada de horarios escolares. Permite crear horarios válidos distribuyendo profesores, grupos y aulas de forma eficiente, evitando conflictos de solapamiento y respetando las restricciones configurables del centro educativo.',
			build: 'Características Principales:\n\nGenerador de Horarios: Algoritmo inteligente que distribuye profesores, grupos y aulas evitando conflictos de disponibilidad. Respeta restricciones personalizables (horas máximas por día, descansos, etc.).\nGestión de Datos: Interfaz para cargar y gestionar profesores, grupos, aulas y franjas horarias. Validación de datos en tiempo real.\nExportación: Generación de archivos para impresión y distribución. Visualización clara de horarios en diferentes vistas (por grupo, profesor, aula).\nOptimización: Algoritmo de mejora continua para obtener los mejores horarios posibles según las restricciones del centro.',
			technologies: ['Python', 'Django', 'JavaScript', 'HTML5', 'CSS3', 'PostgreSQL'],
			media: [
				{ type: 'video', src: 'videos/horarios-demo.mp4', alt: 'Demo en video del Generador de Horarios', poster: 'images/horarios-thumb.jpg' },
				{ type: 'image', src: 'images/CapturaHorario_1.png', alt: 'Pantalla principal del generador de horarios' },
				{ type: 'image', src: 'images/CapturaHorario_2.png', alt: 'Edición de profesores y grupos' },
				{ type: 'image', src: 'images/CapturaHorario_3.png', alt: 'Vista del horario generado' }
			]
		}
	};
	...
	if ($modal.length) {
		...
		$lightbox.on('click', '[data-lightbox-close]', function() {
			closeLightbox();
		});
